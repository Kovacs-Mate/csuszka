...
function csuszik() {
    ...
    if (!mozog) {
        if (
            ...
            this.previousElementSibling.classList[1] == "ures"
        ) {
        ...
        if (
            ...
            this.nextElementSibling.classList[1] == "ures"
        ) {
        ...
        if (
            ...
            this.parentNode.previousElementSibling.children[hanyadik]
                .classList[1] == "ures"
        ) {
        ...
        if (
            ...
            this.parentNode.nextElementSibling.children[hanyadik]
                .classList[1] == "ures"
        ) {
        ...
        if (mozog)
            setTimeout(
                function (c) {
                    document.getElementsByClassName("ures")[0].innerHTML =
                        c.innerHTML;
                    document
                        .getElementsByClassName("ures")[0]
                        .classList.remove("ures");
...
function kesz() {
    ...
    for (let i = 0; i < cellak.length; i++) {
        if (cellak[i].innerHTML == i + 1) {
            cellak[i].classList.add("jo");
        } else {
            cellak[i].classList.remove("jo");
        }
    }
